...
import { Heart, ShieldCheck, Check, Lock, CreditCard, Landmark, Smartphone, ArrowRight, Printer } from 'lucide-react';
        ...
        <div className="bg-[var(--c-surface)] rounded-[32px] p-6 sm:p-10 md:p-12 border border-[var(--c-ink)]/8 shadow-sm">
          ...
          {receipt ? (
            ...
            <form onSubmit={handleDonateSubmit} className="space-y-8">
              ...
              {/* STEP 5: PAYMENT METHOD ABSTRACTION */}
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-[var(--c-ink)]/60 mb-3">
                  5. Payment Channel (Abstracted Layer)
                </label>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    <Smartphone className="w-5 h-5 text-[#F5A623] mb-2" />
                    <span className="text-xs font-semibold text-[var(--c-ink)] block">Mobile Money</span>
                    <span className="text-[10px] text-[var(--c-ink)]/50 block">MTN & Airtel Uganda</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold text-[var(--c-ink)] block">Bank Wire</span>
                    <span className="text-[10px] text-[var(--c-ink)]/50 block">SWIFT Transfer</span>
                  </button>
                </div>
              </div>
